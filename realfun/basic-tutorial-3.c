...
int main(int argc, char *argv[]) {
  ...
  if (!data.pipeline || !data.source || !data.convert || !data.vconvert || !data.resample || !data.sink || !data.vsink) {
  ...
  gst_bin_add_many (GST_BIN (data.pipeline), data.source, data.convert, data.vconvert, data.resample, data.sink, data.vsink, NULL);
