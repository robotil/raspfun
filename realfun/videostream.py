...
while True:
    ...
    if event == 'Stream':
        ...
        if values[0] == True:
            ...
            ourpipeline = 'test-launch "( nvarguscamerasrc ! video/x-raw(memory:NVMM), width=(int)'+values[7]+', height=(int)'+values[8]+', format=(string)NV12, framerate=(fraction)' 
            ...
            ourpipeline = ourpipeline+values['-FRAMERATE-'][0]+'/1 ! ' + encoder + ' bitrate='+values[6]+' '+values[9]+' ! '+ parser +' !   '+ payload + ' name=pay0 pt=96 )" &'
